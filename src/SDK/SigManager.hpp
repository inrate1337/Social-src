...
public:
    ...
    DEFINE_SIG(ContainerScreenController_handleTakeAll, "E8 ? ? ? ? 49 8B ? ? C6 80 ? ? 00 00 01", SigType::RefSig, 1);
    DEFINE_SIG(ContainerScreenController_handleTakeAll_alt, "E8 ? ? ? ? 48 8B 46 ? C6 80 ? ? ? ? ? 48 8B 7E", SigType::RefSig, 1);
    DEFINE_SIG(ContainerScreenController_onContainerSlotHovered, "40 53 48 83 EC 40 48 8B 05 ?? ?? ?? ?? 48 33 C4 48 89 44 24 30 41 8B D8", SigType::Sig, 0);
    DEFINE_SIG(ContainerScreenController_onContainerSlotHovered_alt1, "48 89 5C 24 10 48 89 6C 24 18 48 89 7C 24 20 41 56 48 83 EC 20 45 33 F6 41 8B E8", SigType::Sig, 0);
    DEFINE_SIG(ContainerScreenController_onContainerSlotHovered_alt2, "48 89 ? ? ? 48 89 ? ? ? 41 ? 41 ? 41 ? 48 83 EC ? 45 33 ? 45 8B", SigType::Sig, 0);
    DEFINE_SIG(ContainerScreenController_onContainerSlotHovered_alt3, "48 89 ? ? ? 57 41 ? 41 ? 48 83 EC ? 45 8B ? 48 8B ? 48 8B ? 44 39", SigType::Sig, 0);
    ...
    DEFINE_SIG(OverworldDimension_getBrightnessDependentFogColor, "41 0F 10 08 48 8B C2 0F 28 D3", SigType::Sig, 0);
