...
#include "Commands/StaffCommand.hpp"
#include "Commands/MacrosCommand.hpp"
#include "Features/Events/ChatEvent.hpp"
#include "spdlog/spdlog.h"

static std::vector<std::string> splitCommandArgsQuoted(const std::string& s)
{
...
void CommandManager::init()
{
    ...
    ADD_COMMAND(GotoCommand);
        ADD_COMMAND(StaffCommand);
...
void CommandManager::handleCommand(ChatEvent& event)
{
    ...
    const std::vector<std::string> args = splitCommandArgsQuoted(cmd);
