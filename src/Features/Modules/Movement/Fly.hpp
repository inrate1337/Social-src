...
public:
    ...
    EnumSettingT<Mode> mMode = EnumSettingT("Mode", "The mode of the fly", Mode::Motion, "Motion", "Elytra", "Pregame", "Jump", "Vanilla", "BDS BLOCK");
    ...
    NumberSetting mSpeed = NumberSetting("Speed", "The speed of the fly", 5.6f, 0.f, 300.f, 0.1f);
