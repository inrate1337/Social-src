...
public:
    ...
    float mMoveForwardValue = 0.f;
    float mMoveStrafeValue = 0.f;
    bool mWasStrafeColliding = false;
    float mStrafeDir = 1.0f;
    float mStrafeMoveX = 0.0f;
    float mStrafeMoveY = 0.0f;
