...
public:
    ...
    EnumSettingT<BypassMode> mBypassMode = EnumSettingT("Bypass Mode", "The type of bypass", BypassMode::Raycast, "None", "FlareonV2", "Raycast", "Frizmine");
    ...
    BoolSetting mAimLock = BoolSetting("Aim Lock", "Lock onto one target until lost", true);
    ...
    bool mOrbitRight = true;
    bool mHasOrbitRots = false;
    glm::vec2 mOrbitRots = {};
    bool mInOrbit = false;
    bool mHasLockedTarget = false;
    int64_t mLockedRuntimeID = 0;
