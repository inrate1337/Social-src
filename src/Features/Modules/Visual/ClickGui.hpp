...
public:
    ...
    EnumSettingT<ClickGuiAnimation> mAnimation = EnumSettingT<ClickGuiAnimation>("Animation", "The animation of the ClickGui.", ClickGuiAnimation::Zoom, "Zoom");
    NumberSetting mBlurStrength = NumberSetting("Blur Strength", "The strength of the blur.", 7.f, 0.f, 20.f, 0.1f);
    NumberSetting mEaseSpeed = NumberSetting("Ease Speed", "The speed of the easing.", 35.f, 5.f, 50.f, 0.1f);
    NumberSetting mMinScale = NumberSetting("Min Scale", "The minimal zoom scale for the ClickGui.", 0.7f, 0.0f, 1.0f, 0.01f);
