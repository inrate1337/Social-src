...
public:
    ...
    EnumSettingT<Display> mDisplay = EnumSettingT("Display", "Outline style", Display::None, "Outline", "Bar", "Split", "None");
    ...
    Arraylist() : ModuleBase("Arraylist", "Displays a list of modules", ModuleCategory::Visual, 0, false) {
        addSettings(
            &mBlurStrength,
            &mDisplay,
            &mVisibility,
